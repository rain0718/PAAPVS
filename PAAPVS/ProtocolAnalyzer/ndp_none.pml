...
r0_1[1]表示1到0的通道*/
chan r0_1[2]=[10]of{mtype,byte,Msg};/*报文类型，标志位，报文内容*/
...
RECE_NA0:
	...
	od
/*完成后，判断邻居表中的状态是否可到达*/
DONE0:doneFlag[0]=true;assert(neighbor_cache_host0[0].attribute[2]==1);
}
...
init{
	atomic
	{
		run host0(r0_1[1],r0_1[0]);
		run router1(r0_1[0],r1_2[1],r0_1[1],r1_2[0]);
