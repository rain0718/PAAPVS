...
#define _nstates6	53	/* p3 */
#define minseq6	463
#define maxseq6	514
#define _endstate6	52

#define _nstates5	53	/* p2 */
#define minseq5	411
#define maxseq5	462
#define _endstate5	52

#define _nstates4	93	/* p1 */
#define minseq4	319
#define maxseq4	410
#define _endstate4	92
...
#define _nstates2	258	/* PI */
#define minseq2	54
#define maxseq2	310
#define _endstate2	257

#define _nstates1	28	/* PRes */
#define minseq1	27
#define maxseq1	53
#define _endstate1	27

#define _nstates0	28	/* PIni */
#define minseq0	0
#define maxseq0	26
...
#define PPRes	((P1 *)_this)
typedef struct P1 { /* PRes */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, nonce2) - 1*sizeof(uchar))

#define PPIni	((P0 *)_this)
typedef struct P0 { /* PIni */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 10; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, nonce2) - 1*sizeof(uchar))
...
#endif
	unsigned AcommitB : 1;
	unsigned BrunningA : 1;
	unsigned BcommitA : 1;
	unsigned ArunningB : 1;
	unsigned flag : 1;
	uchar dataIdx;
	uchar priKeyIdx;
	uchar nonce;
...
#else
	#define ACCEPT_LAB	11 /* user-defined accept labels */
#endif
#ifdef MEMCNT
	#ifdef MEMLIM
