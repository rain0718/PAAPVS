...
/*
此版本为加入攻击者版本；
该攻击者可以伪造RS/RA报文进行欺骗，攻击者发送包含无效前缀的路由通告报文RA，被攻击者者h0使用
该地址配置得到的地址是无效的。（伪造前缀信息攻击）
*/
/*IPv6头部*/
typedef IPv6_Header { 
	byte version;/*版本号*/
...
{
	/*
	获取网络内路由器发送给h0的报文，然后进行伪造RA报文欺骗,使得h0获取到的前缀信息无效，
	无法与外界主机进行正常通信
	*/
	Msg rece;
	byte count=0;
